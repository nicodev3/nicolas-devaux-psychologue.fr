...
En thérapie, la cohérence cardiaque peut être utile lorsqu'une personne a besoin de retrouver un minimum de stabilité corporelle avant d'aborder des pensées, des émotions ou des situations difficiles. Elle peut s'intégrer dans les [TCC](/therapie-cognitive-et-comportementale/), les approches de [pleine conscience](/therapie-pleine-conscience/) ou la [thérapie ACT](/therapie-acceptation-et-engagement/).
...
Pour aller plus loin, vous pouvez consulter la page consacrée à la [thérapie pleine conscience à Sceaux](/therapie-pleine-conscience/) ou découvrir les [ateliers de méditation de pleine conscience](/meditation-pleine-conscience-sceaux/).
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Combien de temps faut-il pratiquer la cohérence cardiaque 365 ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Le protocole 365 propose 5 minutes, 3 fois par jour. Une pratique ponctuelle peut aider à faire une pause, mais la régularité permet généralement de mieux installer l'exercice dans le quotidien."
      }
    },
    {
      "@type": "Question",
      "name": "Faut-il inspirer par le nez et expirer par la bouche ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ce n'est pas obligatoire. Le plus important est de trouver une respiration confortable et régulière. Beaucoup de personnes inspirent par le nez et expirent doucement par la bouche, mais d'autres préfèrent respirer uniquement par le nez."
      }
    },
    {
      "@type": "Question",
      "name": "La cohérence cardiaque aide-t-elle en cas d'anxiété ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Elle peut aider à réguler certaines manifestations corporelles de l'anxiété, comme l'agitation, la tension ou la respiration courte. Si l'anxiété est fréquente, intense ou évitée au quotidien, un accompagnement psychologique peut être nécessaire."
      }
    },
    {
      "@type": "Question",
      "name": "Peut-on pratiquer la cohérence cardiaque avant de dormir ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui, si cela vous apaise. Certaines personnes préfèrent la pratiquer en fin de journée ou avant le coucher. D'autres trouvent que suivre un rythme respiratoire demande trop d'attention à ce moment-là. Il faut donc ajuster selon votre expérience."
      }
    },
    {
      "@type": "Question",
      "name": "Que faire si la cohérence cardiaque augmente l'inconfort ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Arrêtez l'exercice, revenez à une respiration naturelle et gardez les yeux ouverts. Vous pouvez essayer plus tard avec un rythme moins strict ou demander conseil à un professionnel."
      }
    }
  ]
}
